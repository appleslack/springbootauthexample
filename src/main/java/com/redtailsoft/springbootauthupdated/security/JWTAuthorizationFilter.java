 ...
 * 
 * This class takes the JWT token that's passed in the request header and converts it to a 
 * valid authToken (UsernamePasswordAuthenticationToken) and passes it up the filter chain.
 */
